...
calliope = CarFactory.create_calliope(25000, 50000, date(2020, 1, 1))
glissade = CarFactory.create_glissade(50000, 75000, date(2020, 1, 1))
palindrome = CarFactory.create_palindrome(True)
rorschach = CarFactory.create_rorschach(45000, 50000, date(2020, 1, 1))
thovex = CarFactory.create_thovex(20000, 75000, date(2022, 1, 1), )
